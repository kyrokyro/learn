      ...
      <main className="flex h-full flex-col bg-violet-900">
        <div className="container">
          ...
          <GridLayout className="" cols={2} rowHeight={125} width={600}>
            {/* <div key="a" className="group flex flex-col h-full bg-neutral-900 border  rounded-xl overflow-hidden border-purple-900 shadow-xl" data-grid={{ x: 0, y: 0, w: 1, h: 2, minW: 1, maxW: 2, minH: 2, maxH: 4 }}>
            ...
            <div key="g" className="group flex flex-col h-full bg-neutral-900 border  rounded-xl overflow-hidden border-purple-900 shadow-xl" data-grid={{ x: 1, y: 2, w: 2, h: 2, minW: 1, maxW: 2, minH: 1, maxH: 2 }}>
              <div className="flex flex-col text-left h-full rounded-t-xl p-4" style={{ backgroundImage: `url("/img/6.jpg")`, height: '100vh', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
                <div className="hs-dropdown relative inline-flex">
                  <button id="hs-dropdown-custom-icon-trigger" type="button" className="hs-dropdown-toggle p-3 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">
                    <svg className="w-4 h-4 text-gray-600" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z" />
            ...
            <div key="b" className="group flex flex-col h-full bg-neutral-900 border  overflow-hidden rounded-xl border-purple-900 shadow-xl" data-grid={{ x: 1, y: 0, w: 1, h: 1, minW: 1, maxW: 2, minH: 1, maxH: 2 }}>
            ...
            <div key="c" className="group flex flex-col h-full text-neutral-100 border  rounded-xl overflow-hidden border-purple-900 shadow-xl p-4" data-grid={{ x: 1, y: 1, w: 1, h: 1, minW: 1, minH: 1 }}>
            ...
            {BlockLink(title, "www.pornhub.com")}
          </GridLayout>
        </div>
      </main>
    </>
